...
export class Ollama {
    constructor(config) {
        ...
        if (!(config === null || config === void 0 ? void 0 : config.proxy)) {
            this.config.host = utils.formatHost((_a = config === null || config === void 0 ? void 0 : config.host) !== null && _a !== void 0 ? _a : 'http://127.0.0.1:11434');
        }
        this.fetch = fetch;
    ...
    processStreamableRequest(endpoint, request) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield utils.post(this.fetch, `${this.config.host}/api/${endpoint}`, Object.assign({}, request), { signal: this.abortController.signal });
            if (!response.body) {
